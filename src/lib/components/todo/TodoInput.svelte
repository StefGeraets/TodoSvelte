...
>
	<div class="flex w-full max-w-lg items-center justify-start">
		...
		<input
			...
			class="h-4 w-4 rounded border border-gray-three bg-cream-four text-green-four focus:border-green-five focus:outline-2 focus:outline-offset-2 focus:outline-green-five"
		/>
